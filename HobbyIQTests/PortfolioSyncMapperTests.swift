...
final class PortfolioSyncMapperTests: XCTestCase {
    ...
    // CF-IOS-DIRECTION-SWEEP (2026-06-18): testDecodePredictionAndMovementFields,
    // testDecodePredictionFieldsNilWhenAbsent, testDecodeMovementFieldsBackwardsCompat
    // removed — they asserted decode + property access for the 10 direction
    // fields (predictedPrice*, movement*) that are now off the
    // InventoryCard struct. Equivalent wire-key-tolerance guards live in
    // DirectionCleanupTests.testWireDecodeTolerates_directionKeys_silently
    // and testWireDecodeTolerates_directionKeys_snakeCase.
