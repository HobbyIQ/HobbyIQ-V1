...
const accelerationEngine_1 = require("../../services/compiq/accelerationEngine");
const listingFloorEngine_1 = require("../../services/compiq/listingFloorEngine");
const absorptionEngine_1 = require("../../services/compiq/absorptionEngine");
const clusterEngine_1 = require("../../services/compiq/clusterEngine");
...
async function cardDecisionHandler(payload) {
    ...
    // 16. FMV Bands
    const fmvBands = (0, fmvBandsEngine_1.getFMVBands)({ comps: compsWithWeights, blendedFMV: fmv, listingFloor: listingFloorResult.listingFloor });
