...
export interface ClusterAnalysis {
  ...
  clusterCenter: number | null;
  variance: number | null;
  clusterTightness: 'tight' | 'normal' | 'wide';
}

export function getClusterAnalysis(prices: number[]): ClusterAnalysis {
  ...
  let clusterTightness: 'tight' | 'normal' | 'wide' = 'normal';
