"""Unit tests for fn-cardhedge-comps get_comps_signal -- CF-FN-COMPS-MIGRATION
Sub-2a (alpha) query strategy.
...
# Importing the function under test requires the fn-cardhedge-comps
...
sys.path.insert(
    0,
    os.path.join(os.path.dirname(__file__), "..", "fn-cardhedge-comps"),
)
...
class GetCompsSignalTests(unittest.TestCase):
    ...
    def test_best_of_top_5_picks_highest_volume_candidate(
        ...
        # Build pricing responses indexed by call order.
        ...
        # signal is one of rising/stable/falling -- not no_data/no_match/no_id
    ...
    def test_year_fallback_when_all_top_5_zero(
        ...
        # First call: primary search returns primary_hits.
        # Second call: year search returns year_hits.
        ...
        # Confirm the two search calls used the documented query patterns.
        ...
        # Year suffix is the current UTC year -- accept any 4-digit year.
    ...
    def test_no_data_signal_when_both_passes_empty(
        ...
        # No selection_path / cardsight_card_id keys set on the
        # no_data branch -- the signal payload is minimal.
    ...
    def test_year_fallback_skipped_when_primary_wins(
        ...
        # Only one search call -- primary; no fallback.
