# Backtest run — 2026-05-26T12-21-15-603Z-r5
...
> Insufficient data — n=? scored, p=0.0150.
...
| Metric | 72h | 7d |
|---|---:|---:|
| MAPE signal-on | 40.96 | 51.8 |
| MAPE signal-off | 23.88 | 25.51 |
| **MAPE delta** (off - on) | **-17.08** | **-26.29** |
| Wilcoxon p-value | 0.032854 | 0.015022 |
...
| conf_40_59 | 13 | 54.449082935144276 | 27.216344369160247 | -27.23273856598403 |
| conf_under_40 | 0 | — | — | — |
