# Backtest run — 2026-05-26T01-42-42-431Z-r3
...
> Insufficient data — n=? scored, p=0.9292.
...
| Metric | 72h | 7d |
|---|---:|---:|
| MAPE signal-on | 30.43 | 34.75 |
| MAPE signal-off | 27.83 | 35.33 |
| **MAPE delta** (off - on) | **-2.6** | **0.57** |
| Wilcoxon p-value | 0.533695 | 0.929153 |
...
| conf_40_59 | 13 | 36.922088835384436 | 36.46084296065991 | -0.4612458747245256 |
| conf_under_40 | 0 | — | — | — |
...
| Ronald Acuna Jr|2018|Topps Update|US250|raw|base | 8.95 | 16.2 | 38.55 | 2 |
| Paul Skenes|2024|Topps Chrome Update|USC53|raw|base | 15.495000000000001 | 80.7 | 93.61 | 2 |

## Top 5 cards where signals hurt most (7d)

| Card | actual | on err% | off err% | delta abs |
|---|---:|---:|---:|---:|
| Shohei Ohtani|2018|Topps Update|US1|PSA 10|base | 471 | 27.39 | 6.16 | 100 |
