# Backtest run — 2026-05-26T01-42-42-431Z-r5
...
| Metric | 72h | 7d |
|---|---:|---:|
| MAPE signal-on | 30.9 | 34.59 |
| MAPE signal-off | 27.43 | 34.93 |
| **MAPE delta** (off - on) | **-3.46** | **0.34** |
| Wilcoxon p-value | 0.284503 | 0.929153 |

| Direction accuracy | signal-on | signal-off | delta (on - off) |
|---|---:|---:|---:|
| 7d direction acc % | 35.71 | 50 | -14.29 |
...
| conf_40_59 | 13 | 36.74592122703212 | 36.03110510075446 | -0.7148161262776611 |
| conf_under_40 | 0 | — | — | — |
...
| Juan Soto|2018|Topps Update|US300|raw|base | 6.58 | 188.75 | 203.95 | 1 |
