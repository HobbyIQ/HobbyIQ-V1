# Backtest run — 2026-05-25T22-58-58-989Z-r4
...
> Insufficient data — n=? scored, p=0.2860.
...
| Metric | 72h | 7d |
|---|---:|---:|
| MAPE signal-on | 28.03 | 36.49 |
| MAPE signal-off | 26.58 | 33.04 |
| **MAPE delta** (off - on) | **-1.45** | **-3.46** |
| Wilcoxon p-value | 1 | 0.286003 |

| Direction accuracy | signal-on | signal-off | delta (on - off) |
|---|---:|---:|---:|
| 7d direction acc % | 28.57 | 50 | -21.43 |
...
| conf_40_59 | 13 | 39.15427800313777 | 35.43330761197429 | -3.720970391163476 |
| conf_under_40 | 0 | — | — | — |
...
| Card | actual | on err% | off err% | delta abs |
|---|---:|---:|---:|---:|
| Mike Trout|2011|Topps Update|US175|PSA 10|base | 1199 | 12.59 | 8.42 | 50 |
