# Backtest run — 2026-05-26T00-05-55-643Z-r1
...
> Insufficient data — n=? scored, p=0.2132.
...
| Metric | 72h | 7d |
|---|---:|---:|
| MAPE signal-on | 35.44 | 34.31 |
| MAPE signal-off | 30.06 | 36.9 |
| **MAPE delta** (off - on) | **-5.39** | **2.59** |
| Wilcoxon p-value | 0.209427 | 0.213223 |

| Direction accuracy | signal-on | signal-off | delta (on - off) |
|---|---:|---:|---:|
| 7d direction acc % | 42.86 | 42.86 | 0 |
...
| conf_40_59 | 13 | 36.80300784711879 | 38.15441676172174 | 1.351408914602949 |
| conf_under_40 | 0 | — | — | — |
...
| Juan Soto|2018|Topps Update|US300|raw|base | 6.58 | 203.95 | 203.95 | 0 |
| Paul Skenes|2024|Topps Chrome Update|USC53|raw|base | 15.99 | 112.63 | 112.63 | 0 |
