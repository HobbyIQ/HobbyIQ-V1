...
**Strategic plan (active 2026-05-28):** See [`docs/HOBBYIQ_ROADMAP_2026-05-28.md`](HOBBYIQ_ROADMAP_2026-05-28.md) for the active 14-week Q3 plan under PROVISIONAL Answer B (shipped product as moat, ML sequenced Q4-2026 → Q1-2027 as optimization layer). The strategic frame is PROVISIONAL pending fresh-session confirmation; the WORK is non-regretful under either fork answer.
