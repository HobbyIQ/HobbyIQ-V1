...
//   USED_EXCELLENT   → 3000  (rejected for cat 261328)
//   USED_VERY_GOOD   → 4000  ← Ungraded ✅
//   LIKE_NEW         → 1500  (rejected: not valid)
//   NEW_OTHER        → 1750  (rejected: not valid)
// No direct Sell API enum maps to conditionId 2750 (Graded). Sending
// USED_VERY_GOOD (→ 4000) for BOTH paths since it's category-valid,
// then letting conditionDescriptors[Grade+Grader] tell eBay this is a
// graded card via descriptor-driven promotion.
