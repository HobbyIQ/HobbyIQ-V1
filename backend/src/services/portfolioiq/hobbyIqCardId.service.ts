...
function knownSetKeyPatterns(): Array<[RegExp, string]> {
  return [
    ...
    // 2024 PANINI SELECT FOOTBALL NAMED INSERT SETS (R60/R38). ABOVE the
    // unanchored `panini-select` catch-all below, which swallows every one of
    // them -- measured, all 33 answered `panini-select` before this block.
    // Longest-first; the tier keys (#2231) are deliberately NOT here, because
    // the tier rows are the product's own base card.
    [/(?:^|-)panini-select-jumbo-rookie-signature-swatch-black-prizm-nfl-shield(?:-|$)/, "panini-select-jumbo-rookie-signature-swatch-black-prizm-nfl-shield"],
    [/(?:^|-)panini-select-jumbo-rookie-signature-swatch-black-prizm-brand-logo(?:-|$)/, "panini-select-jumbo-rookie-signature-swatch-black-prizm-brand-logo"],
    [/(?:^|-)panini-select-jumbo-signature-swatch-black-prizm-nfl-shield(?:-|$)/, "panini-select-jumbo-signature-swatch-black-prizm-nfl-shield"],
    [/(?:^|-)panini-select-jumbo-signature-swatch-black-prizm-brand-logo(?:-|$)/, "panini-select-jumbo-signature-swatch-black-prizm-brand-logo"],
    [/(?:^|-)panini-select-jumbo-rookie-signature-swatch-black-prizm-tag(?:-|$)/, "panini-select-jumbo-rookie-signature-swatch-black-prizm-tag"],
    [/(?:^|-)panini-select-jumbo-signature-swatch-black-prizm-tag(?:-|$)/, "panini-select-jumbo-signature-swatch-black-prizm-tag"],
    [/(?:^|-)panini-select-jumbo-rookie-signature-swatches(?:-|$)/, "panini-select-jumbo-rookie-signature-swatches"],
    [/(?:^|-)panini-select-spectra-hof-signatures-prizm(?:-|$)/, "panini-select-spectra-hof-signatures-prizm"],
    [/(?:^|-)panini-select-rookie-signature-memorabilia(?:-|$)/, "panini-select-rookie-signature-memorabilia"],
    [/(?:^|-)panini-select-draft-selections-memorabilia(?:-|$)/, "panini-select-draft-selections-memorabilia"],
    [/(?:^|-)panini-select-2025-xrc-mystery-autograph(?:-|$)/, "panini-select-2025-xrc-mystery-autograph"],
    [/(?:^|-)panini-select-select-certified-rookies(?:-|$)/, "panini-select-select-certified-rookies"],
    [/(?:^|-)panini-select-jumbo-signature-swatches(?:-|$)/, "panini-select-jumbo-signature-swatches"],
    [/(?:^|-)panini-select-score-select-throwback(?:-|$)/, "panini-select-score-select-throwback"],
    [/(?:^|-)panini-select-signature-memorabilia(?:-|$)/, "panini-select-signature-memorabilia"],
    [/(?:^|-)panini-select-jumbo-rookie-swatch(?:-|$)/, "panini-select-jumbo-rookie-swatch"],
    [/(?:^|-)panini-select-select-signatures(?:-|$)/, "panini-select-select-signatures"],
    [/(?:^|-)panini-select-rookie-signatures(?:-|$)/, "panini-select-rookie-signatures"],
    [/(?:^|-)panini-select-rookie-swatches(?:-|$)/, "panini-select-rookie-swatches"],
    [/(?:^|-)panini-select-hall-selections(?:-|$)/, "panini-select-hall-selections"],
    [/(?:^|-)panini-select-select-numbers(?:-|$)/, "panini-select-select-numbers"],
    [/(?:^|-)panini-select-select-future(?:-|$)/, "panini-select-select-future"],
    [/(?:^|-)panini-select-turbocharged(?:-|$)/, "panini-select-turbocharged"],
    [/(?:^|-)panini-select-watercolors(?:-|$)/, "panini-select-watercolors"],
    [/(?:^|-)panini-select-color-wheel(?:-|$)/, "panini-select-color-wheel"],
    [/(?:^|-)panini-select-signatures(?:-|$)/, "panini-select-signatures"],
    [/(?:^|-)panini-select-phenomenon(?:-|$)/, "panini-select-phenomenon"],
    [/(?:^|-)panini-select-neon-icons(?:-|$)/, "panini-select-neon-icons"],
    [/(?:^|-)panini-select-multiverse(?:-|$)/, "panini-select-multiverse"],
    [/(?:^|-)panini-select-snapshots(?:-|$)/, "panini-select-snapshots"],
    [/(?:^|-)panini-select-alter-ego(?:-|$)/, "panini-select-alter-ego"],
    [/(?:^|-)panini-select-starcade(?:-|$)/, "panini-select-starcade"],
    [/(?:^|-)panini-select-sparks(?:-|$)/, "panini-select-sparks"],
