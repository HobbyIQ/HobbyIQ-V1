...
exports.useDeletePortfolioPosition = useDeletePortfolioPosition;
const react_query_1 = require("react-query");
const portfolio_api_1 = require("../api/portfolio.api");
function useDeletePortfolioPosition() {
    const queryClient = (0, react_query_1.useQueryClient)();
    return (0, react_query_1.useMutation)(portfolio_api_1.deletePortfolioPosition, {
        onSuccess: () => {
