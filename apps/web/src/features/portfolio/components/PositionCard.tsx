...
import { PortfolioPositionViewDto } from '../types/portfolio.types';

export function PositionCard({ view, onClick }: { view: PortfolioPositionViewDto; onClick?: () => void }) {
  return (
    <div onClick={onClick} style={{ background: '#222', borderRadius: 24, boxShadow: '0 2px 8px #0004', padding: 20, marginBottom: 16, cursor: onClick ? 'pointer' : undefined }}>
      ...
      {view.actionPlan.whyNow && view.actionPlan.whyNow.length > 0 && (
        <ul style={{ margin: '8px 0 0 0', padding: 0, listStyle: 'none', color: '#aaa', fontSize: 13 }}>
