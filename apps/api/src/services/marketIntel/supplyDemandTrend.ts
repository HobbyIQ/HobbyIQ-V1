// SupplyDemandTrendService: Computes supply/demand trends for windows
import type { SupplyDemandWindow, CompCalculationContext } from "../../types/marketIntel";

export function computeSupplyDemandTrends(context: CompCalculationContext): SupplyDemandWindow[] {
