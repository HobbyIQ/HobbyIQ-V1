export interface DecisionConfig {
  ...
  strongBuyScoreThreshold: number;
  buyScoreThreshold: number;
  holdScoreThreshold: number;
  trimScoreThreshold: number;
  sellScoreThreshold: number;
  strongSellScoreThreshold: number;
  urgencySpikeThreshold: number;
  riskPenaltyWeight: number;
  catalystBoostWeight: number;
  liquidityPenaltyWeight: number;
  portfolioExposurePenaltyWeight: number;
}

export const decisionConfig: DecisionConfig = {
